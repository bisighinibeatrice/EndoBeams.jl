...
free_radius = 2.3
free_positions = readdlm("stent/input/positions_stent.txt")
connectivity = readdlm("stent/input/connectivity_stent.txt", Int)
constraints_connectivity = readdlm("stent/input/constraints_stent.txt", Int)
...
# filename_target_centerline = "stent/input/cl_rot_model.vtk"
...
filename_target_artery = "stent/input/sdf_rot_model.vtk"
SDFSurface(filename_target_artery)
