        ...
        for iG in 1:comp.nᴳ
            ...
            if contact
                ...
                if pₙ ≉ 0 
                    ...
                    ∂gₙ∂xRₑh₁∂²gₙ∂x² = -dot(∂gₙ∂x, u̇₀) * ∂²gₙ∂x²
                    Rₑᵀ∂²gₙ∂x²Rₑh₁ = Rₑ' * ∂²gₙ∂x² * u̇₀
                    RₑH₁¹Rₑᵀ = Rₑ * H₁¹ * Rₑ'
                    RₑH₁²Rₑᵀ = Rₑ * H₁² * Rₑ'
                    RₑH₁³Rₑᵀ = Rₑ * H₁³ * Rₑ'
                    RₑH₁⁴Rₑᵀ = Rₑ * H₁⁴ * Rₑ'
        
                    𝓐₁¹ =  ∂gₙ∂xRₑh₁∂²gₙ∂x² * RₑH₁¹Rₑᵀ - ∂gₙ∂x * (Rₑ * H₁¹' * Rₑᵀ∂²gₙ∂x²Rₑh₁)'
                    𝓐₁² =  ∂gₙ∂xRₑh₁∂²gₙ∂x² * RₑH₁²Rₑᵀ - ∂gₙ∂x * (Rₑ * H₁²' * Rₑᵀ∂²gₙ∂x²Rₑh₁)'
                    𝓐₁³ =  ∂gₙ∂xRₑh₁∂²gₙ∂x² * RₑH₁³Rₑᵀ - ∂gₙ∂x * (Rₑ * H₁³' * Rₑᵀ∂²gₙ∂x²Rₑh₁)'
                    𝓐₁⁴ =  ∂gₙ∂xRₑh₁∂²gₙ∂x² * RₑH₁⁴Rₑᵀ - ∂gₙ∂x * (Rₑ * H₁⁴' * Rₑᵀ∂²gₙ∂x²Rₑh₁)'
        
                    I∂gₙ∂xRₑ = I∂gₙ∂x * Rₑ
                    I∂gₙ∂xRₑSh₁ = - I∂gₙ∂xRₑ * Sh₁
                    𝓐₂¹ = I∂gₙ∂xRₑSh₁ * Gᵀ¹Rₑᵀ
                    𝓐₂² = I∂gₙ∂xRₑSh₁ * Gᵀ²Rₑᵀ
                    𝓐₂³ = -𝓐₂¹
                    𝓐₂⁴ = I∂gₙ∂xRₑSh₁ * Gᵀ⁴Rₑᵀ
                    ...
                    𝓐₃¹ = I∂gₙ∂x * N₇lₙ² * Rₑ * A₁Ḋr¹ + RₑSGᵀḊ * P₁P¹ * Rₑ'
                    𝓐₃² =                               RₑSGᵀḊ * P₁P² * Rₑ'
                    𝓐₃³ = I∂gₙ∂x * N₇lₙ² * Rₑ * A₁Ḋr³ + RₑSGᵀḊ * P₁P³ * Rₑ'
                    𝓐₃⁴ =                               RₑSGᵀḊ * P₁P⁴ * Rₑ'
        
                    H₁SḊ = H₁F₁
                    𝓐₄¹ = I∂gₙ∂xRₑ * H₁SḊ * Gᵀ¹Rₑᵀ
                    𝓐₄² = I∂gₙ∂xRₑ * H₁SḊ * Gᵀ²Rₑᵀ
                    𝓐₄³ = -𝓐₄¹
                    𝓐₄⁴ = I∂gₙ∂xRₑ * H₁SḊ * Gᵀ⁴Rₑᵀ
                    ...
                    Iμʳᵉᵍġₜġₜ = ID3 - μʳᵉᵍ*ġₜ*ġₜ'
                    RₑH₁ᵀRₑᵀ¹ = RₑH₁ᵀ¹ * Rₑ'
                    RₑH₁ᵀRₑᵀ² = RₑH₁ᵀ² * Rₑ'
                    RₑH₁ᵀRₑᵀ³ = RₑH₁ᵀ³ * Rₑ'
                    RₑH₁ᵀRₑᵀ⁴ = RₑH₁ᵀ⁴ * Rₑ'
        
                    Kᶠᶜ¹ = p′ₙ * 𝓖 * (RₑH₁ᵀRₑᵀ¹ * ∂gₙ∂x)' + pₙ * (∂²gₙ∂x² * RₑH₁¹Rₑᵀ - μʳᵉᵍ * Iμʳᵉᵍġₜġₜ * 𝓐¹ )
                    Kᶠᶜ² = p′ₙ * 𝓖 * (RₑH₁ᵀRₑᵀ² * ∂gₙ∂x)' + pₙ * (∂²gₙ∂x² * RₑH₁²Rₑᵀ - μʳᵉᵍ * Iμʳᵉᵍġₜġₜ * 𝓐² )
                    Kᶠᶜ³ = p′ₙ * 𝓖 * (RₑH₁ᵀRₑᵀ³ * ∂gₙ∂x)' + pₙ * (∂²gₙ∂x² * RₑH₁³Rₑᵀ - μʳᵉᵍ * Iμʳᵉᵍġₜġₜ * 𝓐³ )
                    Kᶠᶜ⁴ = p′ₙ * 𝓖 * (RₑH₁ᵀRₑᵀ⁴ * ∂gₙ∂x)' + pₙ * (∂²gₙ∂x² * RₑH₁⁴Rₑᵀ - μʳᵉᵍ * Iμʳᵉᵍġₜġₜ * 𝓐⁴ )
