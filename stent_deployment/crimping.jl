...
#     max_disp = -0.55 * free_radius           # Inward radial displacement
...
function crimping_ring(free_radius, free_positions, connectivity, output_dir_crimping)
    ...
    # Assembled configuration
    #-------------------------------
    conf = BeamsConfiguration(nodes, beams, nothing, nothing, bcs)
